...
if (!function_exists('mh_magazine_lite_widgets_init')) {
    function mh_magazine_lite_widgets_init() {
        register_sidebar(array(
            'name' => 'Sidebars Login',
            'before_widget' => '<div class="login_register">',
            'after_widget' => '</div>',
            'before_title' => '<h3 class="widget-dynamic-sidebar">',
            'after_title' => '</h3>',
        ));
...
add_action('wp_logout','logout_custom');
...
{
    echo '<span id="footer-thankyou">Developed by <a href="https://www.facebook.com/bluestart9d" target="_blank">SinhBD</a></span>';
}
